...
class FaceDetector(ROS2OPENCV):
    def __init__(self, node_name):
        ...
        self.result = None
        self.count = 0
        self.face_cascade = cv2.CascadeClassifier('/home/abot/8C8PE4/src/face_pkg/scripts/cascades/haarcascade_frontalface_default.xml')
        self.dirname = "/home/abot/8C8PE4/src/face_pkg/scripts/data/jackchen/"
