...
def audio_callback(msg):
    ...
    recognized_text = start_audio()
    rospy.loginfo("Recognition completed, publishing text: %s", recognized_text)
...
def audio_subscriber():
    ...
    global pub
    pub = rospy.Publisher('chinese_topic', String, queue_size=10)
