...
music_path="/home/abot/8C8PE4/src/robot_slam/scripts/start_record.mp3"
music1_path="/home/abot/8C8PE4/src/voice_demo/scripts/end_record.mp3"
...
def start_audio(time=10, save_file="/home/abot/8C8PE4/src/robot_slam/scripts/test.wav"):
    global model
    CHUNK = 1024
    ...
    res = model.generate(input="/home/abot/8C8PE4/src/robot_slam/scripts/test.wav")
